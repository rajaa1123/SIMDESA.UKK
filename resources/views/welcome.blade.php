    ...
    <style>
        * {
        ...
        .hero-section {
            min-height: 100vh;
            background-image:
                linear-gradient(rgba(45, 125, 62, 0.15),
                    rgba(45, 125, 62, 0.15)),
                url('{{ asset("images/Sidokare.png") }}');
...
<body>
        ...
        <div class="container">
            <a class="navbar-brand" href="/">
                <div class="logo-container">
                    <img src="{{ asset('images/logo-sidoarjo.png') }}" alt="Logo Kabupaten Sidoarjo"
                        class="logo-sidoarjo">
                    <div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 hero-content">
                    ...
                    <p class="hero-subtitle">
                        ...
                        Sistem Informasi Desa Sidokare, Kabupaten Sidoarjo. Melayani dengan hati untuk administrasi desa
                        yang lebih mudah, cepat, dan transparan.
                    </p>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6">
                    <div class="feature-card">
                        ...
                        <p class="feature-desc">Kelola data penduduk dan kartu keluarga dengan sistem database yang
                            terorganisir dan mudah diakses.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature-card">
                        ...
                        <p class="feature-desc">Ajukan permohonan surat secara online dengan tracking status real-time
                            dan download hasil surat dalam format PDF.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature-card">
                        ...
                        <p class="feature-desc">Dashboard analitik dengan visualisasi data untuk pengambilan keputusan
                            yang lebih baik.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature-card">
                        ...
                        <p class="feature-desc">Sistem keamanan berlapis dengan enkripsi data dan kontrol akses berbasis
                            role untuk melindungi privasi warga.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature-card">
                        ...
                        <p class="feature-desc">Akses layanan dari berbagai perangkat (HP, tablet, komputer) dengan
                            tampilan responsive.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature-card">
                        ...
                        <p class="feature-desc">Pantau status permohonan surat Anda secara real-time dengan notifikasi
                            otomatis.</p>
                    </div>
                </div>
            </div>
    ...
    <section class="news-section py-5 bg-light" id="news">
        <div class="container py-4">
                ...
                @forelse($latestBerita as $berita)
                    <div class="col-lg-4 col-md-6">
                        <div class="card news-card">
                            ...
                            @if($berita->gambar)
                                <img src="{{ asset('storage/' . $berita->gambar) }}" class="card-img-top news-image"
                                    alt="{{ $berita->judul }}">
                            @else
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between mb-2">
                                    <small class="text-muted"><i class="far fa-calendar-alt me-1"></i>
                                        {{ $berita->published_at->format('d M Y') }}</small>
                                    <small class="text-muted"><i class="far fa-user me-1"></i>
                                ...
                                <a href="{{ route('berita.show', $berita->slug) }}"
                                    class="btn btn-outline-success btn-sm stretched-link">Baca Selengkapnya</a>
                            </div>
                        </div>
                    </div>
                @empty
            ...
            <div class="text-center mt-5">
                <a href="{{ route('berita.index') }}" class="btn btn-village-outline"
    ...
    <section class="cta-section" id="contact">
        <div class="container">
            ...
            <p class="cta-text">Bergabunglah dengan sistem pelayanan desa modern untuk kemudahan akses administrasi Anda
            </p>
            @guest
                <a href="{{ route('login') }}" class="btn btn-village-primary btn-lg"
                    style="background: white; color: var(--primary-green); box-shadow: 0 6px 30px rgba(0,0,0,0.2);">
    ...
    <footer class="footer">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mb-4">
                    <h3 class="footer-title">
                        <img src="{{ asset('images/logo-sidoarjo.png') }}" alt="Logo Sidoarjo"
                            style="height: 40px; margin-right: 10px; vertical-align: middle;">
                        DESA SIDOKARE
                    </h3>
                    <p class="text-white-50">
                        Sistem Informasi Desa SIDOKARE, Kabupaten Sidoarjo. Melayani masyarakat dengan teknologi digital
                        untuk administrasi yang lebih baik.
                    </p>
            ...
            <div class="footer-bottom">
                <p class="mb-0">&copy; {{ date('Y') }} Desa SIDOKARE - Kabupaten Sidoarjo. Sistem Informasi Desa Modern.
                </p>
            </div>
        </div>
    </footer>
