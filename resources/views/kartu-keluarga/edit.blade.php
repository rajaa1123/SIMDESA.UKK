...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Edit Kartu Keluarga</h1>
    ...
    <div class="col-md-8">
        <div class="card shadow">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Form Edit Data Kartu Keluarga</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('kartu-keluarga.update', $kartuKeluarga->id) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('no_kk') is-invalid @enderror" 
                                   id="no_kk" name="no_kk" value="{{ old('no_kk', $kartuKeluarga->no_kk) }}" required 
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('kepala_keluarga') is-invalid @enderror" 
                                   id="kepala_keluarga" name="kepala_keluarga" value="{{ old('kepala_keluarga', $kartuKeluarga->kepala_keluarga) }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('alamat') is-invalid @enderror" 
                                  id="alamat" name="alamat" rows="4" required placeholder="Alamat lengkap termasuk RT/RW">{{ old('alamat', $kartuKeluarga->alamat) }}</textarea>
                        @error('alamat')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-control @error('status') is-invalid @enderror" 
                                ...
                                <option value="Tidak Aktif" {{ old('status', $kartuKeluarga->status) == 'Tidak Aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                                <option value="Pindah" {{ old('status', $kartuKeluarga->status) == 'Pindah' ? 'selected' : '' }}>Pindah</option>
                            </select>
                            @error('status')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
    ...
    <div class="col-md-4">
        <div class="card shadow">
            ...
            <div class="card-body">
                ...
                <ul class="small text-muted">
                    <li>Pastikan data yang diubah sesuai dengan dokumen fisik</li>
                    <li>Perubahan No KK akan mempengaruhi data warga yang terkait</li>
                </ul>
            </div>
        </div>
    </div>
